...
Fünf Szenarien, jedes aus einem **real aufgetretenen** Fehlerfall dieses Skills abgeleitet
(Sitzung 03./04.09.2026, Report `dxAio_template`; Hintergrund je Fall in `references/known-issues.md`,
Einträge 22–28). Jedes Szenario beschreibt in `expected_behavior`, woran ein korrekter Lauf zu
