...
// <SkillID> | v<Version> | <ISO8601-Zeitstempel mit Offset> | <Skill-Name> | <Ergebnis>
...
```
// === work4all-skill-log (v2) ===
// DXJ0001 | v1.0.0 | 2026-08-28T16:03:11+02:00 | fix-folgeseiten-uebertrag-problem | geändert
// DXJ0001 | v1.1.0 | 2026-09-12T09:47:52+02:00 | fix-folgeseiten-uebertrag-problem | keine Änderung nötig
// === end work4all-skill-log ===
```
