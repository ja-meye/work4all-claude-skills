...
|-----------|-------------------------------------------|----------------|-------|-------------|---------|
| DXJ0001   | fix-folgeseiten-uebertrag-problem          | Verbesserung   | Jens  | 2026-08-28  | 1.12.1  |
| DXJ0002   | neuen-devexpress-listenreport-bauen        | Neuerstellung  | Jens  | 2026-08-28  | 1.3.1   |
| DXJ0003   | neuen-devexpress-report-skill-anlegen      | Meta-Skill     | Jens  | 2026-08-30  | 0.8.1   |
...
Seit Meta-Skill v0.3.0 (Baustein 11) bekommt jedes eigenständige Fix-Muster eines Verbesserungs-Skills zusätzlich eine Unterpunkt-ID der Form `<Skill-ID>.<Buchstabe>` (z. B. `DXJ0001.F`). Diese IDs werden NICHT in dieser Tabelle geführt (das würde sie unübersichtlich machen), sondern jeweils im betroffenen Skill selbst (Abschnitt „Unterpunkt-IDs" in dessen `SKILL.md`) sowie gesammelt im Dokumentations-Skill `skill-inhaltsverzeichnis` (`DXJ0004`). Vergabe- und Stabilitätsregeln: siehe `references/unterpunkt-ids.md`.
